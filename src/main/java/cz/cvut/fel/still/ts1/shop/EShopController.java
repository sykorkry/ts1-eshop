package cz.cvut.fel.still.ts1.shop;

import cz.cvut.fel.still.ts1.archive.PurchasesArchive;
import cz.cvut.fel.still.ts1.storage.NoItemInStorage;
import cz.cvut.fel.still.ts1.storage.Storage;
